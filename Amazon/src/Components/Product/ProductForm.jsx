...
//       features: product.features?.length > 0 ? product.features : [''],
//       specifications: product.specifications || { Material: '', Color: '', Weight: '' },
//       image: product.image || "",
//       rating: product.rating || { rate: 0, count: 0 }
//     })
//     setImagePreview(product.image || "")
...
//         setFormData(prev => ({
//           ...prev,
//           image: e.target.result // Store base64 string for immediate preview
//         }))
//       }
//       reader.readAsDataURL(file)
//     }
...
//   // Simulate file upload to cloud service
//   const uploadImageToCloud = async (file) => {
//     setUploadLoading(true)
//     try {
//       // Simulate API call to upload service (Cloudinary, AWS S3, etc.)
//       // Replace this with your actual upload service
//       await new Promise(resolve => setTimeout(resolve, 2000)) // Simulate upload delay
      
//       // In a real application, you would get the image URL from your upload service
//       // For demo purposes, we'll use the base64 string or a placeholder
//       const uploadedImageUrl = `https://example.com/uploads/${Date.now()}_${file.name}`
...
//   // Image URL input handler (fallback)
...
//     }))
//     setImagePreview(url)
//     setSelectedFile(null) // Clear file input when URL is used
//   }

//   // Use predefined image URLs based on category
...
//       ...prev,
//       category: category,
//       image: prev.image || getDefaultImageByCategory(category)
//     }))
//     if (!formData.image) {
//       setImagePreview(getDefaultImageByCategory(category))
//     }
//   }
...
//       showSuccessAlert('Please provide an image URL or upload an image!', 'danger')
//       return
//     }
...
//       } catch (error) {
//         showSuccessAlert('Failed to upload image. Please try again.', 'danger')
//         return
//       }
//     }
...
//                         }}
//                         onError={(e) => {
//                           e.target.src = getDefaultImageByCategory(formData.category)
//                         }}
//                       />
//                     </div>
//                   )}
