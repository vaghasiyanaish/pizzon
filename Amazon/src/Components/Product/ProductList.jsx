...
import { addToCart, addToWishlist, removeFromWishlist } from '../../Services/actions/productActions';
...
const ProductList = () => {
  ...
  // Sample product images for fallback based on category
  ...
  return (
    <Card className="product-card h-100 shadow-sm">
      <div className="card-image-wrapper">
        ...
        <div className="card-overlay">
          <div className="action-buttons">
            ...
            {/* Admin Edit Button - Always show if user is admin */}
            {userInfo?.isAdmin && (
              <Button
                size="sm"
                variant="warning"
            ...
            {/* Admin Delete Button - Always show if user is admin */}
            {userInfo?.isAdmin && (
              <Button
                size="sm"
                variant="danger"
        ...
        <Badge bg="warning" text="dark" className="festival-badge">
      ...
      <Card.Body className="d-flex flex-column">
        ...
        <div className="rating-section mb-3">
          <div className="stars">
            {[...Array(5)].map((_, i) => (
              <i
                key={i}
                className={`fas fa-star ${i < Math.floor(product.rating?.rate || 0) ? 'text-warning' : 'text-muted'}`}
              ></i>
            ))}
          </div>
        ...
        <div className="card-footer mt-auto p-0 bg-transparent border-0">
          <Button
            variant="warning"
            size="sm"
            className="w-100 btn-hover"
