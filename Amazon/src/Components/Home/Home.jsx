...
const Home = () => {
  ...
  const handleDelete = (product) => {
    ...
    setSelectedProduct(product);
    setShowView(false); // Close view modal
          ...
          <Modal.Title className="w-100">
            <div className="d-flex justify-content-between align-items-start">
              ...
              <div className="d-flex align-items-center gap-2">
                ...
                {/* Edit & Delete Buttons for Admin - Moved to top right */}
                {userInfo?.isAdmin && (
                  <>
                    <Button
                      variant="info"
    ...
    <Form>
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <Form.Group className="mb-3">
            ...
            <Form.Select
              value={editData.inStock !== undefined ? editData.inStock : true}
      ...
      <Form.Group className="mb-3">
        ...
        <div className="mt-2">
          ...
          <img
            src={editData.image || "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500&h=500&fit=crop"}
            alt="Product Preview"
          ...
          {editData.features && editData.features.map((feature, index) => (
            <div key={index} className="input-group mb-2">
              ...
              <Button
                ...
                disabled={editData.features.length <= 1}
              >
        ...
        <div className="row">
          ...
          <div className="col-md-4 mb-2">
            <Form.Group>
              ...
              <Form.Control
                type="text"
                value={editData.specifications?.Color || ''}
                onChange={(e) => setEditData({
                  ...editData,
                  specifications: {
                    ...editData.specifications,
          ...
          <div className="col-md-4 mb-2">
            <Form.Group>
              ...
              <Form.Control
                type="text"
                value={editData.specifications?.Weight || ''}
                onChange={(e) => setEditData({
                  ...editData,
                  specifications: {
                    ...editData.specifications,
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <Form.Group className="mb-3">
            <Form.Label className="fw-bold">Rating Count</Form.Label>
            <Form.Control
              type="number"
              min="0"
              value={editData.rating?.count || 0}
              onChange={(e) => setEditData({
                ...editData,
                rating: {
                  ...editData.rating,
      ...
      <div className="mb-3 p-3 bg-light rounded">
        <Form.Label className="fw-bold">Rating Preview</Form.Label>
        <div className="d-flex align-items-center">
          <div className="text-warning me-2">
            {[...Array(5)].map((_, index) => (
              <span key={index}>
                {index < Math.floor(editData.rating?.rate || 0) ? (
                  <i className="fas fa-star"></i>
                ) : index === Math.floor(editData.rating?.rate || 0) && (editData.rating?.rate || 0) % 1 >= 0.5 ? (
          ...
          <span className="text-muted ms-2">
            ({editData.rating?.rate || 0}) • {editData.rating?.count || 0} reviews
          </span>
        </div>
      </div>
    </Form>
  ...
  <Modal.Footer>
    ...
    <Button 
      ...
      className="btn-hover"
      disabled={!editData.title || !editData.price || !editData.category || !editData.description || !editData.brand || !editData.image}
    >
