...
import { createProductAsync, getProductDetailsAsync, updateProductAsync } from '../../Services/actions/productActions'
...
const ProductForm = () => {
  ...
  try {
    ...
    if (isEdit) {
      dispatch(updateProductAsync(id, productData));
    ...
    showSuccessAlert('Image upload failed. Try again.', 'danger');
    console.error(error);
  }
};
    ...
    return (
      <div className="d-flex align-items-center">
        <div className="text-warning me-2">
          {[...Array(5)].map((_, index) => (
            <span key={index}>
              {index < fullStars ? <i className="fas fa-star"></i> :
               index === fullStars && hasHalfStar ? <i className="fas fa-star-half-alt"></i> :
  ...
  const fillTestData = () => {
    const testData = {
      ...
      price: "1299",
      originalPrice: "1999",
      description: "Premium pack of 3 high-quality Adidas cotton t-shirts...",
      category: "fashion",
      brand: "Adidas",
      inStock: true,
      features: ["Pack of 3 t-shirts","100% Premium Cotton","Classic Adidas logo","Moisture-wicking","Modern athletic fit"],
      specifications: { Material: "100% Cotton", Color: "Black/White/Grey", Weight: "450g", Dimensions: "Regular Fit" },
      ...
      {showAlert.show && (
        <Alert variant={showAlert.type} className="alert-fixed">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <button className="btn-close" onClick={() => setShowAlert({ show: false, message: '', type: '' })}></button>
          </div>
        </Alert>
      )}
