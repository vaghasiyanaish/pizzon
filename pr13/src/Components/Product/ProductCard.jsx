...
import { addToCartAsync, addToWishlistAsync, removeFromWishlistAsync } from '../../Services/actions/productActions';
...
const ProductCard = ({ product, onDelete }) => {
  ...
  const handleAddToCart = () => dispatch(addToCartAsync(product, 1));
