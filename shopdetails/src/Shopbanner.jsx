            ...
            <div className="row">
                ...
                <div className="col-6 pe-0">
                    <div className="shop-banner-right position-relative">
                        <img src="https://themes.templatescoder.com/pizzon/html/demo/1-2/01-Modern/images/onion.png" className="shop-image-1 d-none d-lg-block" />
                        <img src="https://themes.templatescoder.com/pizzon/html/demo/1-2/01-Modern/images/banner-leaf.png" className="shop-image-2 d-none d-lg-block" />
                        <img src="https://themes.templatescoder.com/pizzon/html/demo/1-2/01-Modern/images/tamato.png"
                            className="shop-image-3 d-none d-lg-block" />
                        <h3>
